...
products.addProduct('producto prueba', 'este es un producto prueba', 200, 'Sin imagen', 'abc123');
...
products.addProduct('producto prueba', 'este es un producto prueba', 200, 'Sin imagen', 'abc123', 25);
products.addProduct('producto prueba1', 'este es un producto prueba1', 9552, 'Sin imagen', 'def456', 30);
products.addProduct('producto prueba2', 'este es un producto prueba2', 3515, 'Sin imagen', 'ghi789', 35);
